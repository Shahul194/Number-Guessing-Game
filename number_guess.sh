...
if [[ -z $USERNAME_RESULT ]]
  then
    ...
    BEST_GAME=$($PSQL "SELECT MIN(number_of_guess) FROM games LEFT JOIN players USING(user_id) WHERE username='$USERNAME'")
...
INSERT_GAME_RESULT=$($PSQL "INSERT INTO games(user_id, secret_number, number_of_guess) VALUES ($USER_ID_RESULT, $SECRET_NUMBER, $GUESS_COUNT)")
